...
class ObjectCounter(BaseSolution):
    ...
    def __init__(self, **kwargs):
        ...
        # Create tracked_objects directory if it doesn't exist
        self.output_dir = "tracked_objects"
    ...
    def save_label_to_csv(self, track_id, label, action):
        ...
        # Create a filename using the current date in the tracked_objects directory
        filename = os.path.join(self.output_dir, f'tracked_objects_{current_date}.csv')
